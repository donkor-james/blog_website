...
const BlogDetail = () => {
  ...
  const fetchPost = async () =>{
        const response = await fetch( `https://writespace.duckdns.org/api/blog/posts/get/${id}/`,{
      headers:{
    ...
    if (response.ok){
      ...
      const retryResponse = await fetch( `https://writespace.duckdns.org/api/blog/posts/get/${id}/`,{
      headers:{
        "Content-type": "application/json",
  ...
  const handleReaction = async (type) => {
    const response = await fetch(`https://writespace.duckdns.org/api/blog/posts/${post.id}/react/`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
    ...
    if (response.ok) {
      ...
      const retryResponse = await fetch(`https://writespace.duckdns.org/api/blog/posts/${post.id}/react/`, {
        method: 'POST', 
        headers: {
          'Content-Type': 'application/json',
