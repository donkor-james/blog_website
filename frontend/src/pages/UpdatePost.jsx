...
const UpdatePost = () => {
  ...
  const fetchPost = async () => {
    try {
      const response = await fetch(`https://writespace.duckdns.org/api/blog/posts/get/${postId}/`, {
        headers: {
      ...
      if (response.ok) {
        ...
        if (!new_access){
          ...
          const retryResponse = await fetch(`https://writespace.duckdns.org/api/blog/posts/get/${postId}/`, {
            headers: {
              'Content-Type': 'application/json',
    ...
    const handleUpdate = async (e) => {
        ...
        try {
          ...
          if (isEmpty) {
                ...
                const response = await fetch(`https://writespace.duckdns.org/api/blog/posts/update/${postId}/`, {
                    method: "PUT",
                    body: formData,
                    headers: {
                        "Authorization": `Bearer ${access}`
                ...
                if (response.ok) {
                    ...
                    if (!new_access){
                      ...
                      // Retry the request with the new access token
                      const retryResponse = await fetch(`https://writespace.duckdns.org/api/blog/posts/update/${postId}/`, {
                        method: "PUT",
                        body: formData,
                        headers: {
                          "Authorization": `Bearer ${new_access}`
