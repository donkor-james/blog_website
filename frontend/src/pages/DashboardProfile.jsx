...
const DashboardProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`http://138.3.253.196/api/users/update/${user.id}/`, {
        method: "PUT",
      ...
      if (response.ok) {
        ...
        if(new_access){
          const retryResponse = await fetch(`http://138.3.253.196/api/users/update/${user.id}/`, {
            method: "PUT",
            body: formData,
            headers: {
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      const response = await fetch('http://138.3.253.196/api/users/reset-password/', {
        method: "POST",
